...
export default function Navbar() {
  ...
  useEffect(() => {
    const palette = ['#F9ED2E', '#F15E69', '#8099CE'];
...
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 543.84 87.09">
  <g id="Logo">
    ...
    <g id="Petals">
      <path id="Fill" d="M23.41,33.2s-9.55-7.83.28-14.12c10.28-6.57,10.69,9.7,10.69,9.7,0,0,10.96-10.24,15.75-.84,4.79,9.41-11.35,10.52-11.35,10.52,0,0,10.79,11.38-.18,14.15s-10.72-9.47-10.72-9.47c0,0-8.51,9.59-13.04,3.81-4.53-5.78-5.3-13.91,8.57-13.75Z" fill={randomColor}/>
  ...
  <g id="Text">
    <path id="e-fill" d="M472.49,47.99c2.17,2.07,3.25,4.8,3.25,8.2h-24.84c.25-1.51.63-2.87,1.14-4.1,1-2.4,2.49-4.2,4.45-5.4,1.97-1.2,4.39-1.8,7.25-1.8,3.67,0,6.59,1.03,8.75,3.1Z" fill={randomColor}/>
    <g id="re">
